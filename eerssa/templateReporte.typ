...
#let dvdtyp(
  ...
  set page(
    ...
    header: context {
      ...
      box(stroke: (bottom: 0.7pt), inset: 0.2em)[#text(font: "Times New Roman")[#author #h(1fr)#title]]
    },
  )
  ...
  align(center)[
    ...
    #v(0.3em, weak: true)
    #if author != none [#text(14pt)[estado #author]]
  ...
  show outline.entry.where(level: 1): it => {
    text(font: "Times New Roman", accent)[#strong[#it]]
  }
  show outline.entry: it => {
    text(font: "Times New Roman", accent)[#it]
  }
...
#let thmtitle(t, color: rgb("#000000")) = {
  text(font: "Times New Roman", weight: "semibold", fill: color)[#t]
}
#let thmname(t, color: rgb("#000000")) = {
  text(font: "Times New Roman", fill: color)[(#t)]
}
...
#let problema-style = builder-thmbox(color: colors.at(16), shadow: (offset: (x: 2pt, y: 2pt), color: luma(70%)))
#let problema = problema-style("problema", "Problema")


#let error-style = builder-thmbox(color: colors.at(15), shadow: (offset: (x: 3pt, y: 3pt), color: luma(70%)))
#let error = error-style("error", "Error")


#let revisar-style = builder-thmbox(color: colors.at(8), shadow: (offset: (x: 3pt, y: 3pt), color: luma(70%)))
#let revisar = revisar-style("revisar", "Revisar")


#let informativo-style = builder-thmline(color: colors.at(11))
#let informativo = informativo-style("definition", "Informativo")


#let lemma = error-style("lemma", "Lemma")
#let corollary = error-style("corollary", "Corollary")
